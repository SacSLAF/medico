...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
        <div class="bg-white rounded-lg shadow p-6">
            ...
            <a href="<?php echo BASE_URL; ?>doctor/schedule" class="mt-4 block text-blue-600 hover:text-blue-800 text-sm font-medium">
                View Schedule →
            </a>
        </div>
        ...
        <div class="bg-white rounded-lg shadow p-6">
            ...
            <a href="<?php echo BASE_URL; ?>doctor/patients" class="mt-4 block text-green-600 hover:text-green-800 text-sm font-medium">
                Patient List →
            </a>
        </div>
    ...
    <div class="bg-white rounded-lg shadow mb-8">
        <div class="px-6 py-4 border-b flex justify-between items-center">
            ...
            <a href="<?php echo BASE_URL; ?>index.php?url=dashboard/schedule" class="text-blue-600 hover:text-blue-800 text-sm font-medium">
                View Full Schedule
            </a>
        </div>
        <div class="p-6">
                    ...
                    <?php foreach ($todaySchedule as $appointment): ?>
                        <div class="flex items-center justify-between p-4 bg-gray-50 rounded-lg hover:bg-gray-100 transition">
                            ...
                            <div class="flex space-x-2">
                                ...
                                <?php echo $appointment['status'] == 'Scheduled' ? 'bg-blue-100 text-blue-800' : ($appointment['status'] == 'Confirmed' ? 'bg-green-100 text-green-800' : ($appointment['status'] == 'In Progress' ? 'bg-yellow-100 text-yellow-800' : 'bg-gray-100 text-gray-800')); ?>">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <a href="<?php echo BASE_URL; ?>index.php?url=dashboard/schedule" class="bg-white rounded-lg shadow p-6 hover:shadow-md transition text-center">
        ...
        <a href="<?php echo BASE_URL; ?>index.php?url=dashboard/patients" class="bg-white rounded-lg shadow p-6 hover:shadow-md transition text-center">
