...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="bg-white rounded-lg shadow">
        <form method="POST" action="<?php echo BASE_URL; ?>users/update/<?php echo $user['id']; ?>" class="p-6">
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <input type="text" id="username" name="username" required
                               value="<?php echo htmlspecialchars($data['username'] ?? $user['username']); ?>"
                    ...
                    <div>
                        ...
                        <input type="email" id="email" name="email" required
                               value="<?php echo htmlspecialchars($data['email'] ?? $user['email']); ?>"
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <input type="text" id="first_name" name="first_name" required
                               value="<?php echo htmlspecialchars($data['first_name'] ?? $user['first_name']); ?>"
                    ...
                    <div>
                        ...
                        <input type="text" id="last_name" name="last_name" required
                               value="<?php echo htmlspecialchars($data['last_name'] ?? $user['last_name']); ?>"
                    ...
                    <div>
                        ...
                        <input type="tel" id="phone" name="phone"
                               value="<?php echo htmlspecialchars($data['phone'] ?? $user['phone']); ?>"
                    ...
                    <div>
                        ...
                        <select id="role_id" name="role_id" required
                            ...
                            <option value="<?php echo $role['id']; ?>" 
                                    <?php echo (($data['role_id'] ?? $user['role_id']) == $role['id']) ? 'selected' : ''; ?>>
            ...
            <div id="doctor-fields" class="mt-6 grid grid-cols-1 md:grid-cols-2 gap-6 <?php echo ($user['role_id'] == 2) ? '' : 'hidden'; ?>">
                <!-- Specialization -->
                <div>
                    ...
                    <input type="text" id="specialization" name="specialization"
                           value="<?php echo htmlspecialchars($data['specialization'] ?? $user['specialization']); ?>"
                           class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500"
                ...
                <div>
                    ...
                    <input type="text" id="license_number" name="license_number"
                           value="<?php echo htmlspecialchars($data['license_number'] ?? $user['license_number']); ?>"
                           class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500"
            ...
            <div class="mt-6">
                <div class="flex items-center">
                    <input id="is_active" name="is_active" type="checkbox"
                           ...
                           <?php echo (($data['is_active'] ?? $user['is_active']) ? 'checked' : ''); ?>>
